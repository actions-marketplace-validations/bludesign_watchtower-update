...
function sendUpdate(url, apiToken, extraHeaders, timeoutMs) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, axios_1.default)({
            method: 'POST',
            url,
            data: null,
            headers: Object.assign({ Authorization: `Bearer ${apiToken}` }, extraHeaders),
            timeout: timeoutMs,
            maxRedirects: 5,
            validateStatus: () => true,
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const failOnError = core.getInput('fail_on_error').toLowerCase() !== 'false';
            ...
            while (attempt < maxAttempts) {
                ...
                try {
                    lastResponse = yield sendUpdate(url, apiToken, extraHeaders, timeoutMs);
                }
                catch (err) {
                ...
                if (status === 429) {
                    const retryAfter = parseInt(lastResponse.headers['retry-after'] || `${retryDelay}`, 10);
                    core.warning(`Update already in progress (429). Retrying after ${retryAfter}s...`);
                    if (attempt < maxAttempts) {
            ...
            if (body === null || body === void 0 ? void 0 : body.summary) {
                core.setOutput('scanned', (_a = body.summary.scanned) !== null && _a !== void 0 ? _a : 0);
                core.setOutput('updated', (_b = body.summary.updated) !== null && _b !== void 0 ? _b : 0);
                core.setOutput('failed', (_c = body.summary.failed) !== null && _c !== void 0 ? _c : 0);
            }
            if (status === 200) {
                const s = body === null || body === void 0 ? void 0 : body.summary;
                if (s) {
                    core.info(`Update complete: ${(_d = s.scanned) !== null && _d !== void 0 ? _d : 0} scanned, ${(_e = s.updated) !== null && _e !== void 0 ? _e : 0} updated, ${(_f = s.failed) !== null && _f !== void 0 ? _f : 0} failed`);
                }
                else {
                    core.info('Update completed successfully');
                }
                if ((_g = body === null || body === void 0 ? void 0 : body.timing) === null || _g === void 0 ? void 0 : _g.duration) {
                    core.info(`Duration: ${body.timing.duration}`);
                }
            }
            else {
                const errMsg = (body === null || body === void 0 ? void 0 : body.error) || `HTTP ${status}`;
